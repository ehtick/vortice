...
{
    private static readonly GpuPreference[] s_d3dGpuPreferenceMap = new GpuPreference[(int)GpuPowerPreference.Count] {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GpuPreference ToDxgi(this GpuPowerPreference value) => s_d3dGpuPreferenceMap[(uint)value];
